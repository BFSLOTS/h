                        ...
                        <div class="col-md-6 m-auto">
                            <div class="card p-4">
                                ...
                                <div class="form-group ">
                                    {{ Form::label('footer_page_content', __('Footer page Content'), ['class' => 'form-label']) }}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="custom-switch mt-2 custom-left float-right">
                                                <input name="captcha_status" class="form-check-input" type="checkbox"
                                ...
                                <div id="captcha_setting"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('recaptcha_key', env('CAPTCHA_SITEKEY'), ['class' => 'form-control', 'placeholder' => __('Enter recaptcha key')]) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('recaptcha_secret', env('CAPTCHA_SECRET'), ['class' => 'form-control', 'placeholder' => __('Enter recaptcha secret')]) !!}
                                        </div>
                                    </div>
                                </div>
