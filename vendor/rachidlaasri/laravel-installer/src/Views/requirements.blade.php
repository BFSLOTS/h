...
@section('title')
    <i class="ti ti-list-check fa-fw" aria-hidden="true"></i>
        ...
        <ul class="list">
            <li class="list__item list__title {{ $phpSupportInfo['supported'] ? 'success' : 'error' }}">
                ...
                @if($type == 'php')
                    ...
                    <span class="float-right">
                        ...
                        <i class="ti ti-{{ $phpSupportInfo['supported'] ? 'circle-check' : 'box-model' }} row-icon" aria-hidden="true"></i>
                    </span>
                @endif
            </li>
            @foreach($requirements['requirements'][$type] as $extention => $enabled)
                <li class="list__item {{ $enabled ? 'success' : 'error' }}">
                    {{ $extention }}
                    <i class="ti ti-{{ $enabled ? 'circle-check' : 'box-model' }} row-icon" aria-hidden="true"></i>
                </li>
            @endforeach
        </ul>
    @endforeach
